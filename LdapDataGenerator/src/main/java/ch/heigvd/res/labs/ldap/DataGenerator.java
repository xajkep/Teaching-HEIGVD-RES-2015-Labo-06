...
public class DataGenerator {
    ...
    private static String[] functions = {"Etudiant", "Professeur", "Assistant", "Administratif"};
    ...
    public static void main(String[] args) {
        PrintWriter bw = null;
        try {
            bw = new PrintWriter(new OutputStreamWriter(new FileOutputStream("users.csv"), "UTF-8"));
